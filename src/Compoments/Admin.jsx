...
function AdminDashboard() {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    <div className="bg-white p-6 rounded-xl shadow-md flex items-center space-x-4">
      <div className="bg-[#f3e8d2] p-3 rounded-full">
        <FaClipboardList className="text-2xl text-[#744d14]" />
      </div>
      <div>
        <p className="text-gray-500">Total Tours</p>
        <p className="text-xl font-bold text-[#744d14]">0</p>
      </div>
    </div>

    <div className="bg-white p-6 rounded-xl shadow-md flex items-center space-x-4">
      <div className="bg-[#f3e8d2] p-3 rounded-full">
        <FaUsers className="text-2xl text-[#744d14]" />
      </div>
      <div>
        <p className="text-gray-500">People Booked</p>
        <p className="text-xl font-bold text-[#744d14]">0</p>
      </div>
    </div>
    ...
    <div className="bg-white p-6 rounded-xl shadow-md flex items-center space-x-4">
      <div className="bg-[#f3e8d2] p-3 rounded-full">
        <FaMoneyBillAlt className="text-2xl text-[#744d14]" />
      </div>
      <div>
        <p className="text-gray-500">Payments Received</p>
        <p className="text-xl font-bold text-[#744d14]">Rs. 0</p>
      </div>
    </div>
  </div>
</Section>
